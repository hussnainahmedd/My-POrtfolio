...
export const AboutSection: React.FC = () => {
  const aboutParagraphText = "With extensive experience in software engineering and full-stack design, i focus on 3D web interfaces, modern web applications, and user experience. I truly enjoy working with founders and teams aiming to stand out and present their best image. Let's build something incredible together!";
        ...
        <FadeIn delay={0.2} y={20} className="flex flex-col items-center gap-6">
          <div className="flex items-center gap-4 flex-wrap justify-center">
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#D7E2EA]/30 text-[#D7E2EA] hover:bg-[#D7E2EA]/10 transition-colors text-sm uppercase tracking-wider font-medium"
            >
