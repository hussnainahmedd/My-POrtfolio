...
export const AboutSection: React.FC = () => {
  const aboutParagraphText = "With more than five years of experience in design and computer science at air university, i focus on branding, web design, and user experience, i truly enjoy working with businesses that aim to stand out and present their best image. Let's build something incredible together!";
