...
export const AboutSection: React.FC = () => {
  const aboutParagraphText = "I am Hussnain Ahmad, an Undergraduate BSCS student at Air University Islamabad. With experience in full-stack web development, Node.js backends, Android app development, and graph algorithms, i focus on building secure software systems and responsive digital experiences. Let's build something incredible together!";
        ...
        <FadeIn delay={0.2} y={20} className="flex flex-col items-center gap-6">
          <div className="flex items-center gap-3 flex-wrap justify-center max-w-3xl">
            <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#BBCCD7]/40 bg-[#BBCCD7]/10 text-[#BBCCD7] text-xs uppercase tracking-wider font-semibold">
              🎓 Air University Islamabad -- BSCS (2024-Present)
            </span>
            <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#BBCCD7]/40 bg-[#BBCCD7]/10 text-[#BBCCD7] text-xs uppercase tracking-wider font-semibold">
              🏆 HP LIFE Certified -- Agile & Data Science
            </span>
            <a
